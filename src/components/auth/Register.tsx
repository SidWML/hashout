              ...
              <div className=" overflow-hidden    rounded-3xl  w-full ">
                <div className="  p-6 space-y-8">
                  <div className=" text-center font-medium space-y-3">
                    <h1 className=" font-bold md:text-3xl text-xl font-rosario w-full text-center">Create Account </h1>
                  </div>
                  <div className=" space-y-2">
                    <form className=" space-y-6 ">
                      <div className="flex flex-col space-y-2">
                        <label htmlFor="name" className=" font-medium text-[#475569]">
                          Name
                        </label>
                        <input type="text" id="name" className=" px-4 py-3 border focus:outline-sky-500 rounded-[10px]" />
                      </div>
                      <div className="flex flex-col space-y-2">
                    ...
                    <div className=" flex items-center justify-between">
                      <Link href="/login" className=" font-light text-xs underline text-slate-700 dark:text-slate-300">
